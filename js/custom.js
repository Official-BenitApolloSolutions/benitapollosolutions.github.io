...
fetch('https://api.country.is/')
  ...
  .then(data => {
    document.getElementById('country').innerHTML = `Visitor's country: <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-globe" viewBox="0 0 16 16">
             ...
             </svg> ${data.country} ${data.countryInfo.flag ? `<img src="${data.countryInfo.flag}" alt="Flag" style="width:20px; height:auto; vertical-align:middle; margin-left:5px;">` : ''}`;
    window.data = data;
    togglePricingInfo();
  })
